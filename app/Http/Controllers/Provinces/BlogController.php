  ...
  public function blogOne(Request $request)
	{
     ...
     File::delete(public_path('/json/blog/province/'.$fileName));  
     File::put(public_path('/json/blog/province/'.$fileName), $dataFile); 
     return $dataFile; 
		 //return view('blog.blogOne')->with('percent',$percent);
	}

	public function blogTwo(Request $request)
	{
		 //$percents = Percent::all();
      $email = Auth::user()->email;
		  $province =  $request->input('province');
	...
	public function blogThree(Request $request)
	{
		 //$percents = Percent::all();
      $email = Auth::user()->email;
		  $province =  $request->input('province');
      ...
      else
      {
		 ...
		 $percent = round(($result*100)/$allpercent_18_23);
	...
	public function blogFour(Request $request)
	{
		 //$percents = Percent::all();
      $email = Auth::user()->email;
		  $province =  $request->input('province');
