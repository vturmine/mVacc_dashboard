...
<script type="text/javascript">
  function tab(){
   ...
   if(province == 'all')
   {
      var url = '<?php echo e(route("tab_facility_json")); ?>';
   }
   if(province != 'all' && district == 'all')
   {
      var url = '<?php echo e(route("tab_facility_json", "province=:province")); ?>';
   }
   if(province != 'all' && district != 'all')
   {
     var url = '<?php echo e(route("tab_facility_json", "province=:province,district=:district")); ?>';
   }
